...
public class ReportExcelResourceHandler extends ResourceHandlerWrapper {

	// Public Constants
	public static final String LIBRARY_NAME = "pentahoExcelReports";

	// Logger
	private static final Logger logger = LoggerFactory.getLogger(ReportExcelResourceHandler.class);

	// Private Data Members
	private ResourceHandler wrappedResourceHandler;

	public ReportExcelResourceHandler(ResourceHandler wrappedResourceHandler) {
	...
	public Resource createResource(String resourceName, String libraryName) {
		if (LIBRARY_NAME.equals(libraryName)) {
			if (ReportExcelExportResource.RESOURCE_NAME.equals(resourceName)) {
				return new ReportExcelExportResource();
			} else {
	...
	public void handleResourceRequest(FacesContext facesContext) throws IOException {
		...
		if (LIBRARY_NAME.equals(libraryName) && ReportExcelExportResource.RESOURCE_NAME.equals(resourceName)) {
