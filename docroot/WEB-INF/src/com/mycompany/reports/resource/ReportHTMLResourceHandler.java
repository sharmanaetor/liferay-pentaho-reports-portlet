...
public class ReportHTMLResourceHandler extends ResourceHandlerWrapper {

	// Public Constants
	public static final String LIBRARY_NAME = "pentahoHTMLReports";

	// Logger
	private static final Logger logger = LoggerFactory.getLogger(ReportHTMLResourceHandler.class);

	// Private Data Members
	private ResourceHandler wrappedResourceHandler;
	
	public ReportHTMLResourceHandler(ResourceHandler wrappedResourceHandler) {
	...
	public Resource createResource(String resourceName, String libraryName) {
		if (LIBRARY_NAME.equals(libraryName)) {
			if (ReportHTMLExportResource.RESOURCE_NAME.equals(resourceName)) {
				return new ReportHTMLExportResource();
			} else {
	...
	public void handleResourceRequest(FacesContext facesContext) throws IOException {
		...
		if (LIBRARY_NAME.equals(libraryName) && ReportHTMLExportResource.RESOURCE_NAME.equals(resourceName)) {
