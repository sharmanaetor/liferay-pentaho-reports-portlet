...
public class ReportHTMLExportResource extends Resource {

	// Public Constants
	public static final String CONTENT_TYPE = "text/html";
	public static final String RESOURCE_NAME = "exportHTML";
	...
	public ReportHTMLExportResource() {
		setLibraryName(ReportHTMLResourceHandler.LIBRARY_NAME);
	...
	public ReportHTMLExportResource(String reportFileName) {
		this();
		this.reportFileName = reportFileName;
	}

	public ReportHTMLExportResource(String reportFileName, String reportStartDate, String reportEndDate) {
		this();
		this.reportFileName = reportFileName;
	...
	public InputStream getInputStream() throws IOException {
		...
		try {
			...
			// For HTML
			HtmlReportUtil.createStreamHTML(report, byteArray);
